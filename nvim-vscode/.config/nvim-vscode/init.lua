...
vim.keymap.set(
  ...
  -- set `remap` to `true` to use the vscode neovim's keymap: https://github.com/vscode-neovim/vscode-neovim/blob/4d7a9be9be95ea5e8da793fd810345171a865cd2/vim/vscode-motion.vim#L15-L16
