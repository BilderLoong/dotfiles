...
local function vscode_neovim_overrides()
	...
	jvim.keymap.set({ "n", "x" }, "zt", function() vscode.action("reveal", { args = { "top", 0 } }) end, { desc = "Scroll top" })
	jvim.keymap.set({ "n", "x" }, "z.", function() vscode.action("reveal", { args = { "center", 1 } }) end, { desc = "Center + cursor" })
	jvim.keymap.set({ "n", "x" }, "zz", function() vscode.action("reveal", { args = { "center", 0 } }) end, { desc = "Scroll center" })
	jvim.keymap.set({ "n", "x" }, "z-", function() vscode.action("reveal", { args = { "bottom", 1 } }) end, { desc = "Bottom + cursor" })
