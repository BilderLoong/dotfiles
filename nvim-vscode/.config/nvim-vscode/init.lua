...
local function vscode_neovim_overrides()
	...
	jjvim.keymap.set({ "n", "x" }, "zt", function() vscode.action("reveal", { args = { "top", 0 } }) end, { desc = "Scroll top" })
	jjvim.keymap.set({ "n", "x" }, "z.", function() vscode.action("reveal", { args = { "center", 1 } }) end, { desc = "Center + cursor" })
	jjvim.keymap.set({ "n", "x" }, "zz", function() vscode.action("reveal", { args = { "center", 0 } }) end, { desc = "Scroll center" })
	jjvim.keymap.set({ "n", "x" }, "z-", function() vscode.action("reveal", { args = { "bottom", 1 } }) end, { desc = "Bottom + cursor" })
