...
local function vscode_neovim_overrides()
	...
	vim.keymap.set({ "n", "x" }, "z<CR>", function() vscode.call("revealLine", { at = "top" }) end, { desc = "Top + cursor" })
	vim.keymap.set({ "n", "x" }, "zt", function() vscode.call("revealLine", { at = "top" }) end, { desc = "Scroll top" })
	vim.keymap.set({ "n", "x" }, "z.", function() vscode.call("revealLine", { at = "center" }) end, { desc = "Center + cursor" })
	vim.keymap.set({ "n", "x" }, "zz", function() vscode.call("revealLine", { at = "center" }) end, { desc = "Scroll center" })
	vim.keymap.set({ "n", "x" }, "z-", function() vscode.call("revealLine", { at = "bottom" }) end, { desc = "Bottom + cursor" })
	vim.keymap.set({ "n", "x" }, "zb", function() vscode.call("revealLine", { at = "bottom" }) end, { desc = "Scroll bottom" })
