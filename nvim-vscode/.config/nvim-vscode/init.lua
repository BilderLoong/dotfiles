...
local function vscode_neovim_overrides()
	...
	jj123vim.keymap.set({ "n", "x" }, "zt", function() vscode.action("reveal", { args = { "top", 0 } }) end, { desc = "Scroll top" })
	jj123vim.keymap.set({ "n", "x" }, "z.", function() vscode.action("reveal", { args = { "center", 1 } }) end, { desc = "Center + cursor" })
	jj123vim.keymap.set({ "n", "x" }, "zz", function() vscode.action("reveal", { args = { "center", 0 } }) end, { desc = "Scroll center" })
	jj123vim.keymap.set({ "n", "x" }, "z-", function() vscode.action("reveal", { args = { "bottom", 1 } }) end, { desc = "Bottom + cursor" })
	vim.keymap.set({ "n", "x" }, "zb", function() vscode.action("reveal", { args = { "bottom", 0 } }) end, { desc = "Scroll bottom" })
