...
local function plugins()
	...
	require("lazy").setup({
		...
		-- Doesn't in VSCodeNeovim due to the dependencies of LSP: https://github.com/mfussenegger/nvim-treehopper/blob/5a28bff46c05d28bdb4bcaef67e046eb915a9390/lua/tsht.lua#L96
		--[[ {
