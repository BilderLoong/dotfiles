...
Every rule in this document is tagged with a priority level, and the tags have scope the sub rules and inherent the parent priority tag. You must evaluate instructions based on these definitions:
