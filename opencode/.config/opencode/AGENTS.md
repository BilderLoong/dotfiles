...
Every rule in this document is tagged with a priority level, and the tags have scope the subtime and inherite the para. You must evaluate instructions based on these definitions:
