...
If you ever found there is redundant, conflict, confusing, instructions, contradiction in your context, you should surface the problem as earlier as possible, whenever there is a chance.
