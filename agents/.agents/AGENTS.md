...
If you ever found there is redundant, conflict, confusing, instructionscontradiction,  or information in your context, you should surface the problem as earlier as possible, whenever there is a chance.
